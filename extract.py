...
# new data from tweet
with open('./data/ja_tweet.csv') as csv_file:
...
write_df_to_txt('data1/train/train.txt', data_train)
write_df_to_txt('data1/train/text.txt', data_test)
write_df_to_txt('data1/train/dev.txt', data_dev)
